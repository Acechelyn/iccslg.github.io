							...
							<div class="uk-container uk-container-center">
								<div class="uk-grid">
											<div  class="uk-width-medium-1-2">
												...
												<div class="uk-width-medium-1-2">
													<img src="/images/slider/animation.png"/>
														<h2>
														ICC Course Titles under Animation NC3 Program Registration:
													</h2>
													<hr>
								               			 <p>
								               			 	<i class="uk-icon-check"></i><b>2 Year Computer Animation Course</b>
								               			 </p>
								               			 <p>
								               			 	<i class="uk-icon-check"></i><b> 2 Year Applied Film  Animation Course</b>
								               			 </p>
